...
public class MessageReceiver : MonoBehaviour
{
    ...
    private void ListenLoop()
    {
        while (_listener.IsListening)
        {
            try
            {
                HttpListenerContext context = _listener.GetContext();          // blocks until request arrives
    ...
    private static void Respond(HttpListenerResponse resp, int code, string body)
    {
